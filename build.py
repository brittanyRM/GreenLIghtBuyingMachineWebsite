...
CSS = r"""
  ...
  *{box-sizing:border-box}
  ...
  .nav .brand img,.lp-nav .brand img{width:auto;height:56px;display:block;
  ...
  @media(max-width:46rem){
    .nav .brand img,.lp-nav .brand img{height:46px}
  }
  ...
  /* landing page */
  .lp-nav{background:var(--ink-soft);color:var(--paper);padding-block:1.15rem;
    box-shadow:inset 0 -1px 0 rgba(232,231,224,.12)}
...
def nav(current):
  ...
  <div class="wrap">
    <a class="brand" href="index.html"><img src="images/brand/logo-h.webp" srcset="images/brand/logo-h.webp 1x, images/brand/logo-h-2x.webp 2x" alt="Green Light Buying Machine" width="900" height="270"></a>
    <ul>
%s    </ul>
    <span class="nav-cta">
